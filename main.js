...
console.log(
  "Hey! If you see this site throught the console you are a programmer or very inquisitive person. Nice to meet you here :)"
);
...
for (let link of navLinks) {
  link.addEventListener("click", () => {
    ...
    nav.classList.toggle("nav-active");
    burger.classList.toggle("toggle");
    // forEach AGAIN for fix problem with reopening navbar
    navLinks.forEach((link, index) => {
      link.style.animation = "";
    });
  });
